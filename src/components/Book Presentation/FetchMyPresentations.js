...
const useFetchMyPresentations = () => {
  const [myPresentations, setMyPresentations] = useState([]);
  const [localChildData, setLocalChildData] = useState([]);
  ...
  return { myPresentations, localChildData, error };
};

export default useFetchMyPresentations;