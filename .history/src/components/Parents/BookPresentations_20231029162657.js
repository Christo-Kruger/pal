...
const BookPresentations = ({ presentations, toggleExpandCard, expandedPresentation, handleBooking, getUserId, triggerRefresh }) => {
  const handleBookingWithRefresh = async (presentationId, slotId, presentationName, startTime) => {
    // Existing booking logic
    await handleBooking(presentationId, slotId, presentationName, startTime);
    
    // Trigger refresh after booking is done
                ...
                >
                  ...
                  <div className="slot-info">
                    <button
                      ...
                      onClick={ async(e) => {
                        e.stopPropagation();
                        await handleBookingWithRefresh(
                          presentation._id,
                          slot.slotId,
                          presentation.name,
                          moment(slot.startTime).format('HH:mm')
