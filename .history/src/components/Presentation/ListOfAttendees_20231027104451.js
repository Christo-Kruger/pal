...
function CustomToolbar() {
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
      ...
      <div>
        <button onClick={() => { /* Export functionality */ }}>Export to Excel</button>
        <button onClick={() => { /* Previous functionality */ }}>Previous</button>
        <button onClick={() => { /* Next functionality */ }}>Next</button>
        <TextField
          label="Search"
          variant="outlined"
  ...
  return (
    <div className="attendee-list" style={{ marginTop: "100px" }}>
      ...
      <TextField
        ...
        style={{ marginBottom: "20px", width: "300px", }}
        InputProps={{
          style: { padding: "10px", maxHeight:"45px" },
        }}
        InputLabelProps={{
          shrink: true,
        }}
